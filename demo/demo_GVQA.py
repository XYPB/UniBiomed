...
def parse_args():
    ...
    parser.add_argument(
        '--save_dir',
        default='./val_results/Grounded_Vision_Question_Answer/RadGenome',
        help='save path')
    parser.add_argument(
        '--launcher',
...
class GVQAInferenceDataset:
    ...
    def get_questions(self):
        import random
        question = random.choice(VQA_QUESTIONS).strip()
        return question
    ...
    def __getitem__(self, index):
        ...
        question = question.strip().format(anatomy=anatomy)
...
def main():
    ...
    results = collect_results_cpu(results, len(dataset), tmpdir='./gvqa_eval_tmp')
