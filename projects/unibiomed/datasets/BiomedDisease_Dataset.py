...
SEG_QUESTIONS = [
     'Can we observe any signs of abnormality? Please respond with interleaved segmentation masks for the corresponding parts.',
     'Can we see abnormality? Please highlight the region with interleaved segmentation masks.',
     'Can abnormality be identified? Please output with interleaved segmentation masks for the corresponding phrases.',
     'Can abnormality be observed? Please output with interleaved segmentation masks for the corresponding phrases.',
     'Are there any visible indications of abnormality? Please respond with interleaved segmentation masks for the corresponding parts.',
     'Are there any observable signs of abnormality? Please highlight the region with interleaved segmentation masks.',
     'Does the visual features suggest the presence of abnormality? Please output with interleaved segmentation masks for the corresponding phrases.',
     'Are there any clear indications of abnormality? Please output with interleaved segmentation masks for the corresponding phrases.',
...
class DiseaseBiomedDataset(RefBiomedDataset):
    ...
    def _parse_annotations(self, ann_info):
        ...
        for i, phrase in enumerate(phrases):
            ...
            answer = random.choice(ANSWER_LIST) + ' ' + phrase + '.'
    ...
    def prepare_data(self, index):
        ...
        out_data_dict['question'] = data_dict['question']
        out_data_dict['answer'] = data_dict['answer']
