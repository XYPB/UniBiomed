    ...
    def load_data_list(self) -> List[dict]:
        ...
        for image in images_list:
            ...
            for ann in corresponding_anno:
                ...
                data_info = {
                    'img_path': join_path(self.data_root, image['file_name']),
...
class RegionMedtrinityDataset(RefBiomedDataset):
    ...
    def __init__(self,
        ...
        print("Medtrinity dataset, include {} items.".format(len(self)))
    ...
    def _parse_annotations(self, ann_info):
        ...
        for i, phrase in enumerate(phrases):
            question = random.choice(Medtrinity_QUESTIONS).format(class_name=phrase)
            if i == 0:
