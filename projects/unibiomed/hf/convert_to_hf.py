...
def main():
    ...
    from projects.unibiomed.hf.models.configuration_sa2va_chat import Sa2VAChatConfig
    from projects.unibiomed.hf.models.modeling_sa2va_chat import Sa2VAChatModel
